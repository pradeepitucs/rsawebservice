...
public class UserVehicleManagementResource {
	...
	public ModelAndView updateUserVehicle(
			@RequestParam(value = "vehicleid", defaultValue = "0") final int iVehicleId,
			@RequestParam(value = "isenabled") final boolean isEnabled,
			@RequestParam(value = "year") final int iYear,
		...
		UserVehicleModel userVehicleModel1 = getUserVehicleService().updateUserVehicle(userVehicleModel, vehicleModel, vehicleFuelTypeModel, vehicleTypeModel);
	...
	@RequestMapping(value = "/vehiclebodytypes", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/vehiclebodytype", method = { RequestMethod.POST })
	...
	@RequestMapping(value = "/vehiclefueltypes", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/vehiclefueltype", method = { RequestMethod.POST })
	...
	@RequestMapping(value = "/vehiclemanufacturers", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/vehiclemanufacturer", method = { RequestMethod.POST })
	...
	@RequestMapping(value = "/vehicleinformationmodels", method = { RequestMethod.GET })
	public ModelAndView vehicleInformationModels() {
		...
		for (VehicleInformationModel vehicleInformationModel : vehicleInformationModelList) {
			...
			vehicleInformationModelDTO
					.setVehicleInformationModelId(vehicleInformationModel.getVehicleInformationModelId());
	...
	@RequestMapping(value = "/vehicleinformationmodel", method = { RequestMethod.POST })
	public ModelAndView vehicleInformationModel(
			@RequestParam("vehicleinformationmodelid") final int iVehicleInformationModelId) {

		VehicleInformationModel vehicleInformationModel = new VehicleInformationModel();
		vehicleInformationModel = getUserVehicleService().get(VehicleInformationModel.class,
				iVehicleInformationModelId);
	...
	@RequestMapping(value = "/vehiclemodelsdetailsbymanufacturer", method = { RequestMethod.POST })
	...
	@RequestMapping(value = "/vehicleinformationmobyvehiclemodel", method = { RequestMethod.POST })
