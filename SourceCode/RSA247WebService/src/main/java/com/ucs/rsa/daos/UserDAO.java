...
public interface UserDAO extends BaseDAO {
	 ...
	 * Update customer.
	 *
	 * @param iCustomerModel the i customer model
	 ...
	 * Login.
	 *
	 * @param iMobileNo the i mobile no
	 * @param iGcmId the i gcm id
	 * @return the string
	 */
	 ...
	 *
	 * @param serviceProviderServiceMatchingModelList the service provider service matching model list
	 ...
	 *
	 * @param imageFolderName the image folder name
	 * @param accepttermAndCondition the acceptterm and condition
	 * @return the string
	 */
	 ...
	 * @param isMembership the is membership
	 * @return the customer model
	 */
	 ...
	 *
	 * @param serviceProviderNumber the service provider number
