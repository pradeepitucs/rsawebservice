	...
	<div class="w3-col m9">
		<div class="w3-container ">
			<table class="table display table-striped table-bordered table:hover"
				...
				<tbody>
					<c:forEach var="vehicleFuel" items="${vehiclefueltypes.vehicleFuelTypeDTOs}">
						<tr>
							<td>${vehicleFuel.vehicleFuelTypeId}</td>
							<td>${vehicleFuel.vehicleFuelTypeName}</td>
							<td>${vehicleFuel.isEnabled}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
