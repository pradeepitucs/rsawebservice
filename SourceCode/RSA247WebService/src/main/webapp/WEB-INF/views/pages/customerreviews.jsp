	...
	<div class="w3-col m9">
		<div class="w3-container ">
			<table class="table display table-striped table-bordered table:hover"
				...
				<tbody>
					<c:forEach var="customerreview" items="${customerreviews.customerReviewDTOs}">
						<tr>
							<td>${customerreview.customerReviewId}</td>
							<td>${customerreview.approvalStatus}</td>
							<td>${customerreview.blocked}</td>
							<td>${customerreview.comment}</td>
							<td>${customerreview.creationTime}</td>
							<td>${customerreview.headline}</td>
							<td>${customerreview.rating}</td>
							<td>${customerreview.isEnabled}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
