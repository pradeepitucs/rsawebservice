	...
	<div class="w3-col m9">
		<div class="w3-container ">
			<table class="table display table-striped table-bordered table:hover"
				...
				<thead>
					<tr>
						<th>Vehicle Manufacturer ID</th>
						<th>Vehicle Manufacturer Name</th>
						<th>Active</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="vehicleManufacturer" items="${vehiclemanufacturers.vehicleManufacturerDTOs}">
						<tr>
							<td>${vehicleManufacturer.manufacturerId}</td>
							<td>${vehicleManufacturer.manufacturerName}</td>
							<td>${vehicleManufacturer.isEnabled}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
