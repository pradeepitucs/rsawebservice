    ...
    <aside id="left_column">
      <nav>
        <ul class="maketree" id="treeversion">
			<li>Customer Issue
				<ul>
					<li><a href="${pageContext.servletContext.contextPath}/servicerequest/findAllCustomerRequests">All Customer Issue</a></li>
				</ul>
			</li>
			<%-- <ul>
		 ...
		 <%--  <li>Employee
		    <ul>
		      <!-- <li><a href="someHref">Edit/View</a></li>
		      <li><a href="someHref">Chapter 2</a></li> -->
		      <li><a href="${pageContext.servletContext.contextPath}/allemployees">All Employee</a>
		        <ul>
