    		...
    		$.ajax({
				...
				success : function(data) {	
		            ...
		            for (var i = 0; i < xx.length; i++) {
                  	 ...
                  	 var img = $('<img src="data:image/png;base64,' + xx[i] + '" />');
                	 img.attr("style", "height:200px;width: 200px;border:1px solid #434343; margin:5px;");					                       		 
                  	 dvPreview.append(img);
                  	 }
					},
				 error: function (request, status, error) {
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/validatation.js"></script>
<style>
	...
	*/
	...
	(min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		*/
		...
		td:nth-of-type(2):before { content: "ServiceProviderId"; }
		td:nth-of-type(3):before { content: "Mobile Number"; }
		td:nth-of-type(4):before { content: "ServiceProvider City"; }
		td:nth-of-type(5):before { content: "ServiceProvider Name"; }
		td:nth-of-type(6):before { content: "ServiceProvider Website"; }
		td:nth-of-type(7):before { content: "ServiceProvider Timing"; }
		td:nth-of-type(8):before { content: "Status"; }
		td:nth-of-type(9):before { content: "ServiceProvider Comments"; }
		td:nth-of-type(10):before { content: "ServiceProvider NightOperation"; }
		td:nth-of-type(11):before { content: "ServiceProvider Premium"; }
		td:nth-of-type(12):before { content: "ServiceProvider Latitude"; }
		td:nth-of-type(13):before { content: "ServiceProvider Longitude"; }
		td:nth-of-type(14):before { content: "ServiceProvider MaxDistanceToOperate"; }
		td:nth-of-type(15):before { content: "ImageFolderName"; }
		td:nth-of-type(16):before { content: "Rating"; }
		td:nth-of-type(17):before { content: "ServiceProvider Timestamp"; }
		td:nth-of-type(18):before { content: "FourWheeler"; }
		td:nth-of-type(19):before { content: "TwoWheeler"; }
		td:nth-of-type(20):before { content: "ElectricalType"; }
		td:nth-of-type(21):before { content: "MechanicalType"; }
		td:nth-of-type(22):before { content: "BodyRepair"; }
        ...
        <div class="w3-container">
         <h4 class="w3-center">Filters</h4> 
			<div class="w3-accordion w3-white">
			  ...
			  <spring:url value="/user/serviceProvidersCities" var="userActionUrl" />
			  
			  <form:form class="form-horizontal" method="post" modelAttribute="userForm" action="${userActionUrl}">
			  
			  <button onclick="myFunction('Demo1')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-university fa-fw w3-margin-right" ></i> City</button>
			  <div id="Demo1" class="w3-accordion-content w3-container">
				...
				<div class="form-group ${status.error ? 'has-error' : ''}">
							...
							<div class="col-sm-10">
								<form:checkboxes  items="${serviceProviderCities}" element="label class='checkbox-inline'" />
								
								
							</div>
						</div>
				  <a href="#"><input type="checkbox" name="vehicle" value="Pune"> Pune</a>
				  <a href="#"><input type="checkbox" name="vehicle" value="Mumbai"> Mumbai</a>
				  <a href="#"><input type="checkbox" name="vehicle" value="Delhi"> Delhi</a>
				  <a href="#"><input type="checkbox" name="vehicle" value="hyderabad"> hyderabad</a>
				  <a href="#"><input type="checkbox" name="vehicle" value="Bangalore"> Bangalore</a>
			  </div>
			  <button onclick="myFunction('Demo2')" class="w3-btn-block w3-theme-l1 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> Status</button>
          ...
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
            	<section style="display: flex;">
				  ...
				  <br>
	              <span><a id="btn1" class="approve" href="#" style="margin-bottom:16px!important; border:1px solid #000;display:inline-block;outline:0;padding:6px 16px;vertical-align:middle;overflow:hidden;text-decoration:none!important;text-align:center;cursor:pointer;white-space:nowrap;color:#000 !important; background-color:#faed1b !important">Approve</a></span>
				  <span><a id="myBtn" class="showImage" href="#" style="margin-bottom:16px!important; border:1px solid #000;display:inline-block;outline:0;padding:6px 16px;vertical-align:middle;overflow:hidden;text-decoration:none!important;text-align:center;cursor:pointer;white-space:nowrap;color:#000 !important; background-color:#faed1b !important">Service Provider Image</a></span>
				  <span><a id="myBtn1" class="showIDImage" href="#" style="margin-bottom:16px!important; border:1px solid #000;display:inline-block;outline:0;padding:6px 16px;vertical-align:middle;overflow:hidden;text-decoration:none!important;text-align:center;cursor:pointer;white-space:nowrap;color:#000 !important; background-color:#faed1b !important">ID Image</a></span>
			  			  
				<table id="dataTable" style="display: block; overflow-x: auto; max-width:100%; height:450px;">
					<thead>
						<tr>
							<th>Select</th>
					...
					<c:forEach var="serProvider" items="${findAllServiceProviders.serviceProviderDTOs}" >
						<tr>
							<td><input type="radio"  name="spname" id="serviceProviderid" value="${serProvider.userId}"/></td>
							<td style="display: none" class="serviceProviderIdclass" id="id">${serProvider.userId}</td>
