	...
	<div class="w3-col m9">
		<div class="w3-container ">
			<table class="table display table-striped table-bordered table:hover"
				...
				<thead>
					<tr>
						<th>User Vehicle ID</th>
						<th>User ID </th>
						<th>User Vehicle Reg No</th>
						<th>Active</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="userVehicle" items="${vehicles.userVehicleDTOs}">
						<tr>
							<td>${userVehicle.vehicleId}</td>
							<td>${userVehicle.userId}</td>
							<td>${userVehicle.vehicleRegNo}</td>
							<td>${userVehicle.isEnabled}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
