	...
	<div class="w3-col m9">
		<div class="w3-container ">
			<table class="table display table-striped table-bordered table:hover"
				...
				<thead>
					<tr>
						<th>Vehicle Body Type ID</th>
						<th>Vehicle Body Type Name</th>
						<th>Active</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="vehicleBody" items="${vehiclebodytypes.vehicleBodyTypeDTOs}">
						<tr>
							<td>${vehicleBody.vehicleBodyTypeId}</td>
							<td>${vehicleBody.vehicleBodyTypeName}</td>
							<td>${vehicleBody.isEnabled}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
